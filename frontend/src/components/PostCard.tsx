...
const PostCard = ({title , content , bookmark , authorName , id} : PostcardProps) => {
  ...
  return <>
    <div onClick={handleDivClick} className="max-w-sm w-full h-full p-6 bg-white border hover:shadow-lg hover:shadow-slate-400 duration-200 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
      ...
      <div className="pt-8 flex flex-row-reverse items-center ">
